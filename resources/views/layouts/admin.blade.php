                        ...
                        <div class="sidebar">
                            ...
                            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
                                <div class="list-group list-group-flush">
                                    <a href="{{ route('admin.dashboard') }}" class="list-group-item list-group-item-action py-2 ripple {{ Route::currentRouteName() === 'admin.dashboard' ? 'list-group-item-action list-group-item-danger' : ''}}" aria-current="true">
